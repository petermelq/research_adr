...
if __name__ == '__main__':
    ...
    minute_bar_dir = os.path.join(SCRIPT_DIR,'..','data','raw','adrs','minute_bars_UNADJUSTED')
    output_filename = os.path.join(SCRIPT_DIR,'..','data','processed','adrs','adr_volume_since_local_close.parquet')
