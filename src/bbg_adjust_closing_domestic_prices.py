...
if __name__ == "__main__":
    ...
    raw_local_price_filename = os.path.join(script_dir, '..', 'data', 'raw', 'ordinary', f'ord_PX_LAST_adjust_all.csv')
    output_filename = os.path.join(script_dir, '..', 'data', 'processed', 'ordinary', f'bbg_ord_close_to_usd_adr_PX_LAST_adjust_all.csv')
