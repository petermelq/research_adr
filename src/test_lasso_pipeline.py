"""
Test the LASSO pipeline on a few stocks.
...
from train_lasso_models import train_rolling_models
...
def main():
    ...
    print("=" * 70)
    print("LASSO Pipeline Test - Running on Test Stocks")
    print("=" * 70)
    ...
    models_dir = __script_dir__ / '..' / 'data' / 'processed' / 'models' / 'with_us_stocks' / 'lasso_test'
