"""
Train LASSO models for ordinary stock residual prediction.
...
class LASSOResidualModel:
    """
    LASSO model for predicting ordinary stock residuals.
    ...
    def fit(self, X_train, y_train, X_val, y_val):
        ...
        # Fit final model
        self.model = Lasso(alpha=best_alpha, fit_intercept=False, max_iter=10000)
...
def train_rolling_models(ticker, features_df, output_dir, train_months=11):
    ...
    """
    print(f"\n{'=' * 70}")
    print(f"Training LASSO models for {ticker}")
    print(f"{'=' * 70}")
...
def main():
    """
    Train LASSO models for all ordinary stocks.
    """
    print("=" * 70)
    ...
    models_dir = __script_dir__ / '..' / 'data' / 'processed' / 'models' / 'with_us_stocks' / 'lasso'
